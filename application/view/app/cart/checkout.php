                    ...
                    <div class="content-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-sm-9">
                                    <h5><i class="bi bi-clock me-3"></i> تامین و ارسال سفارش: <span class="fw-lighter">5 روز کاری دیگر</span> </h5>
                                </div>
                                <div class="col-sm-3">
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    function updatePrices() {
                                        ...
                                        const shipping = parseInt(selected.dataset.postal);
                                        const shippingText = shipping === 0 ? 'رایگان می‌باشد' : shipping.toLocaleString() + ' تومان';
                                        shippingLabel.textContent = shippingText;
                                        const total = productPrice + shipping;
                                        totalLabel.textContent = total.toLocaleString() + ' تومان';

                                        // مقداردهی به فیلدهای مخفی
                                        selectedAddressInput.value = selected.value;
                                    ...
                                    updatePrices(); // اجرا هنگام لود صفحه
                                });
                            </script>
                            <?php foreach ($adders as $i => $adder) { ?>
                                <label for="address-<?= $i ?>" class="d-block">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="me-4 border-end border-2 pe-3 border-dark">
                                                <input type="radio"
                                                    ...
                                                    value="<?= $adder['address_id'] ?>"
                                                    data-postal="<?= $adder['postal_price'] ?>"
                                                    <?= $i === 0 ? 'checked' : '' ?>>
                                            </div>
                                            <div class="d-flex flex-column">
                                                <h5 class="ms-2 text-muted"><?= $adder['AddressText'] ?></h5>
                                                <div class="detail-order-item d-flex align-items-center">
                                                    <h6><i class="bi bi-pin-map-fill me-1"></i> استان و شهر: <?= $adder['province_name'] ?> , <?= $adder['city_name'] ?></h6>
                                                </div>
                                                <div class="detail-order-item d-flex align-items-center">
                                                    <h6><i class="bi bi-truck me-1"></i> هزینه ارسال: <?= $adder['postal_price'] == 0 ? 'رایگان می‌باشد' : number_format($adder['postal_price']) . ' تومان'; ?>
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <?php foreach ($orders as $order) { ?>
                            <div class="col-sm-3">
                                <div class="pro-box-item p-3 img-thumbnail shadow-box text-center">
                                    <h4><?= $order['name'] ?></h4>
                                    <a href="<?php $this->asset($order['img']) ?>">
                                        ...
                                        <div class="pro-box-var mt-4 justify-content-center">
                                            ...
                                            <div class="pro-box-var-item px-1">
                                                <div class="pro-box-var-item-color" style="background:<?php if ($order['color'] == 'hue' || $order['color'] == '') {
                                                                                                            echo ('linear-gradient(to right, red, orange, yellow, green, blue, indigo, violet);');
                                                                                                        } else {
                                                                                                            echo $order['color'];
                                                                                                        } ?>;"></div>
                ...
                <div class="col-xl-3">
                    <div class="content-box position-sticky top-0">
                        <div class="container-fluid">
                            <div class="item">
                                <div class="factor">
                                    <form method="post" action="<?php $this->url('/cart/pardahct') ?>">
                                        <input type="hidden" name="selected_address_id" id="selected-address-id">
                                        <input type="hidden" name="final_total_price" id="final-total-price">
