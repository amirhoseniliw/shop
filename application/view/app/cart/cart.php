                                                    ...
                                                    <div class="item d-flex align-items-center">
                                                        ...
                                                        <div class="saller-name text-muted">
                                                            <div class="product-meta-color-items mt-0" style="line-height: 1">
                                                                <span class="seller-color" style="background: <?php if($order['color'] == 'hue') { echo('linear-gradient(to right, red, orange, yellow, green, blue, indigo, violet);');} else {echo $order['color'] ;}?>"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="col-12">
                    <div class="row gy-4">
                        <div class="col-xl-9">
                            <div class="content-box">
                                <div class="container-fluid">
                                    <div class="footer-service mt-0 pt-0">
                                        <nav class="navbar navbar-expand">
                                        ...
                                        <div class="search-form mt-4">
                                            ...
                                            <form action="">
                                                <div class="search-filed">
                                                    <input type="text" placeholder="اعمال کد تخفیف" class="form-control search-input">
