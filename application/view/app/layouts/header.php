...
<div class="header">
    ...
    <span class="top-header-user-panel-text">پنل کاربری</span>  
                            ...
                            <?php }?>
                        <a class="top-header-cart btn" data-bs-toggle="offcanvas" href="ثقثث" role="button" aria-controls="offcanvasCart">
                ...
                <div class="col-lg-9">
                    <div class="top-menu-menu">
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item">
                                <a href="<?php $this->url('/product/index/cheap') ?>" class="nav-link border-animate f-600 fromCenter">
