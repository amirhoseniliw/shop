...
if (isset($_SESSION['user_id'])) {
    ...
    $favorites = $favoritesModel->find_all($user_id);
}
?>
                ...
                <ul class="navbar-nav justify-content-between w-100 ">
                    <li class="nav-item">
                        <div class="nav-link footer-service-item d-flex align-items-center">
                            ...
                            <div class="footer-service-item-desc ms-3">
                                ...
                                <small class="text-muted"> 09399376644 تماس با  </small>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <div class="nav-link footer-service-item d-flex align-items-center">
                            ...
                            <div class="footer-service-item-desc ms-3">
                                <p>تضمین  <strong> کیفیت کالا</strong></p>
                                <small class="text-muted">خرید بهترین کالای موجود</small>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="nav-link footer-service-item d-flex align-items-center">
                            ...
                            <div class="footer-service-item-desc ms-3">
                                <p>پرداخت امن از  <strong>درگاه بانکی</strong></p>
                                <small class="text-muted">امنیت در خریدهای آنلاین</small>
                            </div>
                        </div>
                    </li>
                </ul>
                        ...
                        <div class="col-sm-7">
                            <nav class="navbar navbar-expand pt-0 mt-0 justify-content-center ">
                                <ul class="navbar-nav ">
                                    ...
                                    <li class="nav-item footer-namad-item"><a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=613920&Code=kEupDMBwJ8yLFABMsgOAOc45Zvc2Hnne'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=613920&Code=kEupDMBwJ8yLFABMsgOAOc45Zvc2Hnne' alt='' style='cursor:pointer' code='kEupDMBwJ8yLFABMsgOAOc45Zvc2Hnne'></a></li>
                                    <li class="nav-item footer-namad-item"><style>#zarinpal{margin:auto} #zarinpal img {width: 80px;}</style>
<div id="zarinpal">
<script src="https://www.zarinpal.com/webservice/TrustCode" type="text/javascript"></script>
                ...
                <div class="col-12">
                    <div class="row gy-4">
                        <div class="col-lg-2">
                            <div class="footer-logo-parent"> </br>
                                    </hr>
...
<div class="copy-right mt-5">
 ...
 <a href="https://amirhoseniliw.ir" class="text-decoration-none text-info" target="_blank">
      <i class="bi bi-person-circle fs-4 me-2"></i> <!-- آیکون بوت‌استرپ (اگر استفاده می‌کنی) -->
      <span style="">سازنده سایت</span>
    </a>
                </div>
                <div class="col-sm-6">
    ...
    <ul class="d-table-row">
        ...
        <li class="d-table-cell"><a href="<?php $this->url('/UserPanel/favorites') ?>" class="mf-link nav-link text-center">
            <div class="mf-link-icon position-relative d-table mx-auto">
                ...
                <span class="position-absolute main-color-one-bg rounded-pill font-10 text-white badge" style="right:-40%;bottom:-5px;"><?php if($favorites !== null) { echo count($favorites) ;} else {echo "0" ;} ?></span>
            </div>
        ...
        <li class="d-table-cell"><a class="mf-link nav-link text-center" data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasCart">
            <div class="position-relative mf-link-icon d-table mx-auto">
                ...
                <span class="position-absolute main-color-one-bg rounded-pill font-10 text-white badge" style="right:-60%;bottom:-5px;"><?= (isset($_SESSION['cart']) &&  $_SESSION['cart'] != null) ? count($_SESSION['cart']) : '0'; ?></span>
            </div>
...
<script>
  ...
  // حالت ۱: وقتی کامل لود شد
  window.addEventListener('load', hideLoader);

  // حالت ۲: اگه تا 10 ثانیه چیزی لود نشد، باز هم لودر رو حذف کن
  setTimeout(hideLoader, 200); // 10000 میلی‌ثانیه = 10 ثانیه

document.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('.fav-toggle-btn').forEach(function (button) {
    button.addEventListener('click', function () {
      ...
      fetch(url, {
        ...
        .then(result => {
          const isFav = this.getAttribute('data-is-fav') === '1';

          if (isFav) {
            icon.style.color = '#aaa';
            this.setAttribute('data-is-fav', '0');
            this.setAttribute('data-bs-title', 'افزودن به علاقه‌مندی');
          } else {
            icon.style.color = 'red';
            this.setAttribute('data-is-fav', '1');
            this.setAttribute('data-bs-title', 'حذف از علاقه‌مندی');
          }
        })
    ...
    document.querySelectorAll('.fav-toggle-btn').forEach(function (button) {
      button.addEventListener('click', function (e) {
        ...
        .then(result => {
          if (result === 'added') {
            icon.style.color = 'red';
            button.setAttribute('data-is-fav', '1');
            button.setAttribute('data-bs-title', 'حذف از علاقه‌مندی');
          } else if (result === 'removed') {
            icon.style.color = '#aaa';
            button.setAttribute('data-is-fav', '0');
            button.setAttribute('data-bs-title', 'افزودن به علاقه‌مندی');
          }

          // ری‌اینیشیالایز tooltip اگر استفاده می‌کنی
          if (bootstrap?.Tooltip) {
            const tooltip = bootstrap.Tooltip.getInstance(button);
            if (tooltip) {
              tooltip.setContent({ '.tooltip-inner': button.getAttribute('data-bs-title') });
            }
          }
        })
        .catch(err => {
...
<script src="<?php $this->asset('js/plugin/swiper/swiper-bundle.min.js') ?>"></script>
<script src="<?php $this->asset('js/plugin/countdown/countdown.js') ?>"></script>
<script src="<?php $this->asset('js/plugin/rasta-contact/script.js') ?>"></script>
<script src="<?php $this->asset('js/plugin/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js') ?>"></script>
