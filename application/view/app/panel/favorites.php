                        ...
                        <ul class="row gy-3 ps-0">
                                ...
                                <div class="cart-canvas border rounded-3 p-3">
                                    <div class="row align-items-center">
                                        <div class="col-4 ps-0">
                                            <img src="assets/img/product/product-5.webp" width="200" alt="">
                                        </div>
                                        <div class="col-8">
                            ...
                            <div class="col-sm-6">
                                <div class="cart-canvas p-3 border rounded-3">
                                    <div class="row align-items-center">
                                        <div class="col-4 ps-0">
                                            <img src="assets/img/product/product-4.webp" width="200" alt="">
                                        </div>
                                        <div class="col-8">
                                            <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                Automatico Ghost Reserve
                            ...
                            <div class="col-sm-6">
                                <div class="cart-canvas p-3 border rounded-3">
                                    <div class="row align-items-center">
                                        <div class="col-4 ps-0">
                                            <img src="assets/img/product/product-3.webp" width="200" alt="">
                                        </div>
                                        <div class="col-8">
                                            <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                Automatico Ghost Reserve
                            ...
                            <div class="col-sm-6">
                                <div class="cart-canvas p-3 border rounded-3">
                                    <div class="row align-items-center">
                                        <div class="col-4 ps-0">
                                            <img src="assets/img/product/product-2.webp" width="200" alt="">
                                        </div>
                                        <div class="col-8">
                                            <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                Automatico Ghost Reserve
                            ...
                            <div class="col-sm-6">
                                <div class="cart-canvas border rounded-3 p-3">
                                    <div class="row align-items-center">
                                        <div class="col-4 ps-0">
                                            <img src="assets/img/product/product-1.webp" width="200" alt="">
                                        </div>
                                        <div class="col-8">
                                            <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                Automatico Ghost Reserve
                            ...
                            <div class="col-sm-6">
                                <div class="cart-canvas p-3 border rounded-3">
                                    <div class="row align-items-center">
                                        <div class="col-4 ps-0">
                                            <img src="assets/img/product/product-6.webp" width="200" alt="">
                                        </div>
                                        <div class="col-8">
                                            <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                Automatico Ghost Reserve
