...
<img alt="error404" class="img-fluid" 
     src="<?php echo assetWithVersion($this->asset('/img_site/banerr/0101.jpg')) ?>">

</div>
<div class="swiper-slide">

    <img alt="error404" class="img-fluid"
         src="<?php echo assetWithVersion($this->asset('/img_site/banerr/02.jpg')) ?>">

</div>
<div class="swiper-slide">

    <img alt="error404" class="img-fluid"
         src="<?php echo assetWithVersion($this->asset('/img_site/banerr/03.jpg')) ?>">

</div>
<div class="swiper-slide">

    <img alt="error404" class="img-fluid"
         src="<?php echo assetWithVersion($this->asset('/img_site/banerr/04.jpg')) ?>">
...
<?php foreach ($Selected_posts as $Selected_post): ?>
    <div class="swiper-slide">
        <div class="product-box">
            <a href="<?php echo $this->url('/product/find/'. $Selected_post['product_id']); ?>">
                <div class="product-image">
                    <?php
                        $imageUrlsArrays = explode(',', $Selected_post['photo_file_names']);
                        $alt_text = explode(',', $Selected_post['alt_texts']);
                    ?>
                    <img src="<?php echo $this->asset($imageUrlsArrays[0]); ?>" alt="<?= $alt_text[0] ?>" class="img-fluid one-image">
                    <img src="<?php echo $this->asset($imageUrlsArrays[1]); ?>" alt="<?= $alt_text[1] ?? $alt_text[0]; ?>" class="img-fluid two-image">
                </div>
                <div class="product-title">
                    <div class="title">
                        <p class="title-font">
                            <?= $Selected_post['name'] ?><br>
                            <u>کده <?= $Selected_post['product_id'] ?></u>
                        </p>
                    </div>
                </div>
                <div class="product-action">
                    ...
                    <div class="price">
                        <p class="new-price"><?= $this->formatPrice($Selected_post['price']) ?></p>
            ...
            if ($favorites !== null) {
                foreach ($favorites as $favorite) {
                    if ($Selected_post['product_id'] == $favorite['product_id']) {
                        $found = true;
                        break;
                    }
                }
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <nav class="navbar navbar-expand">
                        <ul class="navbar-nav align-items-center">
                            <li class="nav-item">
                                <a href="<?php echo $this->url('/product/find/'. $Selected_post['product_id']); ?>"
                                   class="product-box-hover-item product-box-hover-item-btn"
                                   data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="مشاهده سریع">
                            ...
                            <li class="nav-item mx-3">
                                <a href="<?php echo $this->url('/product/find/'. $Selected_post['product_id']); ?>"
                                   class="product-box-hover-item product-box-hover-item-btn"
                                   data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="افزودن به سبد خرید">
  ...
  data-url="<?php $this->url('/product/add_favorites/' . $Selected_post['product_id']) ?>"
  data-is-fav="<?= $found ? '1' : '0' ?>"
  style="background:none; border:none; padding:0"
>
  <i class="bi bi-heart-fill fav-icon" style="<?= $found ? 'color:red;' : 'color:#aaa;' ?>"></i>
</button>
            ...
            <div class="product-timer justify-content-center border-top pt-2 mb-0"></div>
        </div>
    </div>
<?php endforeach; ?>
</div>
    ...
    <div class="product-slider free-sw site-slider mt-5">
        ...
        <div class="parent parent-two">
            ...
            if ($favorites !== null) {
                foreach ($favorites as $favorite) {
                    if ($Bestseller_posts_all['product_id'] == $favorite['product_id']) {
                        $found = true;
                        break;
                    }
                }
  ...
  class="fav-toggle-btn"
  data-url="<?php $this->url('/product/add_favorites/' . $Bestseller_posts_all['product_id']) ?>"
  data-is-fav="<?= $found ? '1' : '0' ?>"
  style="background:none; border:none; padding:0"
>
  <i class="bi bi-heart-fill fav-icon" style="<?= $found ? 'color:red;' : 'color:#aaa;' ?>"></i>
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            <div class="advert-item advert-box-item">
                <a href="<?php echo $this->url('/product/category/4') ?>">
                    <img src="<?php echo assetWithVersion($this->asset('/img_site/banerr/adary.jpg')) ?>" class="rounded-4" alt="">
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="advert-item advert-box-item">
                <a href="<?php echo $this->url('/product/category/9') ?>">
                    <img src="<?php echo assetWithVersion($this->asset('/img_site/banerr/N.jpg')) ?>" class="rounded-4" alt="">
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="advert-item advert-box-item">
                <a href="<?php echo $this->url('/product/category/3') ?>">
                    <img src="<?php echo assetWithVersion($this->asset('/img_site/banerr/K.jpg')) ?>" class="rounded-4" alt="">
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="advert-item advert-box-item">
                <a href="<?php echo $this->url('/product/category/7') ?>">
                    <img src="<?php echo assetWithVersion($this->asset('/img_site/banerr/B.jpg')) ?>" class="rounded-4" alt="">
                </a>
            </div>
        </div>
...
<div class="col-lg-4">
    <div class="advert-item advert-box-item-two">
        <a href="<?php echo $this->url('/product/category/2') ?>">
            <img src="<?php echo assetWithVersion($this->asset('/img_site/banerr/daftar.jpg')) ?>" class="rounded-4" alt="">
        </a>
    </div>
</div>
    ...
    <div class="product-slider free-sw site-slider mt-5">
        ...
        <div class="parent">
            ...
            if ($favorites !== null) {
                foreach ($favorites as $favorite) {
                    if ($all_post['product_id'] == $favorite['product_id']) {
                        $found = true;
                        break;
                    }
                }
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <nav class="navbar navbar-expand">
                                            <ul class="navbar-nav align-items-center">
                                                ...
                                                <li class="nav-item"> <button
  class="fav-toggle-btn"
  data-url="<?php $this->url('/product/add_favorites/' . $all_post['product_id']) ?>"
  data-is-fav="<?= $found ? '1' : '0' ?>"
  style="background:none; border:none; padding:0"
>
  <i class="bi bi-heart-fill fav-icon" style="<?= $found ? 'color:red;' : 'color:#aaa;' ?>"></i>
    ...
    <?php $this->include('app.layouts.footer' , compact('favorites')); ?>