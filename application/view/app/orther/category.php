                ...
                <div class="swiper-slide">
                    <a href="">
                        <div class="slider-category-item">
                            ...
                            <div class="slider-category-item-image">
                                <img src="assets/img/mega-img-2.jpg" alt="">
                            </div>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="">
                        <div class="slider-category-item">
                            ...
                            <div class="slider-category-item-image">
                                <img src="assets/img/mega-img-3.jpg" alt="">
                            </div>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="">
                        <div class="slider-category-item">
                            ...
                            <div class="slider-category-item-image">
                                <img src="assets/img/mega-img-4.jpg" alt="">
                            </div>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="">
                        <div class="slider-category-item">
                            ...
                            <div class="slider-category-item-image">
                                <img src="assets/img/mega-img-5.jpg" alt="">
                            </div>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="">
                        <div class="slider-category-item">
                            ...
                            <div class="slider-category-item-image">
                                <img src="assets/img/mega-img-6.jpg" alt="">
                            </div>
                        </div>
                    </a>
                </div>
                                        ...
                                        <div class="title">
                                            <div class="form-check form-switch  form-sw-custom">
                                                <div class="d-flex align-items-center justify-content-end flex-row-reverse">
                                                    ...
                                                    <input class="form-check-input d-block" type="checkbox" role="switch" id="flexSwitchCheckDefault1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="accordion accordion-flush" id="accordionFlushExample1">
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed f-800" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne1" aria-expanded="false" aria-controls="flush-collapseOne1">
                                                        جستجو
                                                    </button>
                                                </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed f-800" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo1" aria-expanded="false" aria-controls="flush-collapseTwo1">
                                                        محدوده قیمت
                                                    </button>
                                                </h2>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed f-800" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree1" aria-expanded="false" aria-controls="flush-collapseThree1">
                                                        دسته بندی
                                                    </button>
                                                </h2>
                                                        ...
                                                        <form action="">
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                                <div class="form-check">
                                                                    <label for="colorCheck1" class="form-check-label">موبایل <i class="bi bi-phone ms-1"></i></label>
                                                                    <input type="checkbox" name="" id="colorCheck1" class="form-check-input">
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                                <div class="form-check">
                                                                    <label for="colorCheck5" class="form-check-label">ایرپاد <i class="bi bi-earbuds ms-1"></i></label>
                                                                    <input type="checkbox" name="" id="colorCheck5" class="form-check-input">
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                                <div class="form-check">
                                                                    <label for="colorCheck4" class="form-check-label">تبلت <i class="bi bi-tablet ms-1"></i></label>
                                                                    <input type="checkbox" name="" id="colorCheck4" class="form-check-input">
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                                <div class="form-check">
                                                                    <label for="colorCheck3" class="form-check-label">هدست <i class="bi bi-headset ms-1"></i></label>
                                                                    <input type="checkbox" name="" id="colorCheck3" class="form-check-input">
                                                                </div>
                                                                <div>
                    ...
                    <div class="item-boxs">
                        ...
                        <div class="item-box shadow-box">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed f-800" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                            جستجو
                                        </button>
                                    </h2>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-sm-7">
                            <nav class="navbar navbar-expand pt-0 mt-0 justify-content-center ">
                                <ul class="navbar-nav ">
                                    <li class="nav-item footer-namad-item"><a href="" class="nav-link mt-0 pt-0 text-muted-two"><img src="assets/img/namad-03.png" class="img-thumbnail" alt=""></a></li>
                                    <li class="nav-item footer-namad-item"><a href="" class="nav-link mt-0 pt-0 text-muted-two"><img src="assets/img/enamad.png" class="img-thumbnail" alt=""></a></li>
                                    <li class="nav-item footer-namad-item"><a href="" class="nav-link mt-0 pt-0 text-muted-two"><img src="assets/img/rezi.png" class="img-thumbnail" alt=""></a></li>
                                </ul>
                            </nav>
