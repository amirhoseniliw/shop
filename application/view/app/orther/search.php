...
<div class="content mt-3">
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-check">
                                                        <label for="colorCheck111"
                                                            class="form-check-label"><?= $category['category_name'] ?> <img
                                                    ...
                                                    <div>
                                                        <span
                                                            class="fw-bold font-14">(<?= $category['post_count'] ?>)</span>
                                                    </div>
                                                </div>
                                                <?php  } ?>
  ...
  data-url="<?php $this->url('/product/add_favorites/' . $post['product_id']) ?>"
